package test.ibaokang.com.test.tabbar;
...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public MainNavigateTabBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList tabTextColor = typedArray.getColorStateList(R.styleable.MainNavigateTabBar_navigateTabTextColor);//导航栏文字默认颜色
        ColorStateList selectedTabTextColor = typedArray.getColorStateList(R.styleable.MainNavigateTabBar_navigateTabSelectedTextColor);//导航栏文字选中颜色
